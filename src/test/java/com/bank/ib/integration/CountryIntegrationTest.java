...
public class CountryIntegrationTest {
    ...
    public void getAllCountryTest() throws Exception {
        ...
        this.mockMvc.perform(get("/admin/country/"))
    ...
    public void createCountryTest() throws Exception {
        ...
        this.mockMvc.perform(post("/admin/country/")
    ...
    public void updateCountryTest() throws Exception {
        ...
        this.mockMvc.perform(put("/admin/country/" + country.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(json))
                .andExpect(status().isOk());
    }
    ...
    @Test
    public void removeCountryTest() throws Exception {
        ...
        this.mockMvc.perform(delete("/admin/country/" + country.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(json))
